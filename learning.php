...
if(empty($_GET['sentence']) !== true){
  ...
  if($i <= count($data)){
    $data[$i]['sentenceWithGap'] = str_replace('__________', '<input type="text" name="answer" required>', $data[$i]['sentenceWithGap']); //Ersetzt die Lücke mit einem Input
  }
}
 ?>
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="content">
      <h1>Satz <?php echo $_GET['sentence']."/10" ?></h1>
